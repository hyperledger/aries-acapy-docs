...
Exchange](https://github.com/hyperledger/aries-rfcs/blob/0.9.0/features/0023-did-exchange/README.md).
...
[RFC 434 Out of Band](https://github.com/hyperledger/aries-rfcs/tree/0.9.0/features/0434-outofband) and the "reuse connection" as the invitee. In PR #1453
