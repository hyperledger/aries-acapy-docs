...
Following parameters can be used in a configuration file like [this](https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.1rc1/demo/demo-args.yaml).
...
Find an example in [default_logging_config.ini](https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.1rc1/aries_cloudagent/config/default_logging_config.ini).
...
For `DictConfig` (`dict` logging config file), find an example in [default_per_tenant_logging_config.yml](https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.1rc1/aries_cloudagent/config/default_per_tenant_logging_config.yml) with same attributes as `default_per_tenant_logging_config.ini` file.
