...
Following parameters can be used in a configuration file like [this](https://github.com/hyperledger/aries-cloudagent-python/tree/1.0.0-rc2/demo/demo-args.yaml).
...
Find an example in [default_logging_config.ini](https://github.com/hyperledger/aries-cloudagent-python/tree/1.0.0-rc2/aries_cloudagent/config/default_logging_config.ini).
