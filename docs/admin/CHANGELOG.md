...
- Verifiable credential, presentation and revocation handling updates
  ...
  - Pre-populate revoc_reg_id on IssuerRevRegRecord [\#1924](https://github.com/hyperledger/aries-cloudagent-python/pull/1924) ([andrewwhitehead](https://github.com/andrewwhitehead))
...
- Out of Band (OOB) and DID Exchange / Connection Handling
  ...
  - include image_url in oob invitation [\#1966](https://github.com/hyperledger/aries-cloudagent-python/pull/1966) ([Zzocker](https://github.com/Zzocker))
...
- Hyperledger Indy Endorser/Author Transaction Handling
  ...
  - chore: fix ACAPY_PROMOTE-AUTHOR-DID flag [\#1978](https://github.com/hyperledger/aries-cloudagent-python/pull/1978) ([morrieinmaas](https://github.com/morrieinmaas))
...
- Demo and Documentation Updates
  ...
  - Fixed bug in run_demo script [\#1982](https://github.com/hyperledger/aries-cloudagent-python/pull/1982) ([pasquale95](https://github.com/pasquale95))
  ...
  - Redis Plugins \[redis_cache & redis_queue\] related updates [\#1937](https://github.com/hyperledger/aries-cloudagent-python/pull/1937) ([shaangill025](https://github.com/shaangill025))
