...
If the wallet is configured the default way in eg. [demo-args.yaml](https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.0rc2/demo/demo-args.yaml), without explicit wallet-storage, a sqlite database file is used.
