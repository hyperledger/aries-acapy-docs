...
## [aries-acapy-plugin-redis-events](https://github.com/hyperledger/aries-acapy-plugins/blob/1.0.0rc5/redis_events/README.md) `redis_queue`
...
More details can be found [here](https://github.com/hyperledger/aries-acapy-plugins/blob/1.0.0rc5/redis_events/README.md).
...
example [docker-compose.yml](https://github.com/hyperledger/aries-acapy-plugins/blob/1.0.0rc5/redis_events/docker/docker-compose.yml) file is available which launches both ACA-Py with redis and an accompanying Redis cluster.
...
## [aries-acapy-cache-redis](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/1.0.0rc5/README.md) `redis_cache`
...
More details can be found [here](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/1.0.0rc5/README.md).
...
example [docker-compose.yml](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/1.0.0rc5/docker-compose.yml) file in the root of the
...
- To launch ACA-Py with an accompanying redis cluster of 6 nodes (3 primaries and 3 replicas), please refer to example [docker-compose.cluster.yml](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/1.0.0rc5/docker-compose.cluster.yml) and run the following:
