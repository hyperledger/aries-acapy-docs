...
# [aries-acapy-cache-redis](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/0.10.5/README.md) [`redis_cache`]
...
More details can be found [here](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/0.10.5/README.md).
...
example [docker-compose.yml](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/0.10.5/docker-compose.yml) file in the root of the
...
- To launch ACA-Py with an accompanying redis cluster of 6 nodes [3 primaries and 3 replicas], please refer to example [docker-compose.cluster.yml](https://github.com/Indicio-tech/aries-acapy-cache-redis/blob/0.10.5/docker-compose.cluster.yml) and run the following:
