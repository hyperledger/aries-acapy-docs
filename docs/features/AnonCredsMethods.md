...
[initialization routine]: https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.2rc1/aries_cloudagent/anoncreds/__init__.py
[example of the registration]: https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.2rc1/aries_cloudagent/anoncreds/default/legacy_indy/registry.py
...
look at the methods in the current version of [aries_cloudagent/anoncreds/base.py](https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.2rc1/aries_cloudagent/anoncreds/base.py) in the `main` branch.
...
["legacy" Indy]: https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.2rc1/aries_cloudagent/anoncreds/default/legacy_indy
[did:indy]: https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.2rc1/aries_cloudagent/anoncreds/default/did_indy
[did:web]: https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.2rc1/aries_cloudagent/anoncreds/default/did_web

Models for the API are defined [here](https://github.com/hyperledger/aries-cloudagent-python/tree/0.12.2rc1/aries_cloudagent/anoncreds/models)
...
[AnonCreds Issuer]: https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.2rc1/aries_cloudagent/anoncreds/issuer.py#L56
[Revocation Setup]: https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.2rc1/aries_cloudagent/anoncreds/revocation_setup.py
