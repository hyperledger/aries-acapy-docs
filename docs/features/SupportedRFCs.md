...
Profiles](https://github.com/hyperledger/aries-rfcs/tree/0.12.0rc0/concepts/0302-aries-interop-profile),
...
| [Revocable AnonCreds Credentials](https://github.com/hyperledger/indy-hipe/tree/0.12.0rc0/text/0011-cred-revocation) | :white_check_mark:        |         |
| Multi-Tenancy      | :white_check_mark:        | [Documentation](https://github.com/hyperledger/aries-cloudagent-python/blob/0.12.0rc0/Multitenancy.md) |
...
All RFCs listed in [AIP 1.0](https://github.com/hyperledger/aries-rfcs/tree/0.12.0rc0/concepts/0302-aries-interop-profile#aries-interop-profile-version-10) are fully supported in ACA-Py. The following table
...
All RFCs listed in [AIP 2.0](https://github.com/hyperledger/aries-rfcs/tree/0.12.0rc0/concepts/0302-aries-interop-profile#aries-interop-profile-version-20) (including the sub-targets)
...
| [0317-please-ack](https://github.com/hyperledger/aries-rfcs/tree/0.12.0rc0/features/0317-please-ack) |  :x: | An investigation was done into supporting `please-ack` and a number of complications were found. As a result, we expect that `please-ack` will be dropped from AIP 2.0. It has not been implemented by any Aries frameworks or deployments. |

### Other Supported RFCs

| RFC | Supported | Notes |
| --- | :--: | -- |
| [0031-discover-features](https://github.com/hyperledger/aries-rfcs/blob/0.12.0rc0/features/0031-discover-features/README.md)           | :white_check_mark:        | Rarely (never?) used, and in implementing the V2 version of the protocol, the V1 version was found to be incomplete and was updated as part of Release 0.7.3  |
| [0028-introduce](https://github.com/hyperledger/aries-rfcs/blob/0.12.0rc0/features/0028-introduce/README.md)            | :white_check_mark:        |      |
| [00509-action-menu](https://github.com/hyperledger/aries-rfcs/blob/0.12.0rc0/features/0509-action-menu/README.md)       | :white_check_mark:        |      |
