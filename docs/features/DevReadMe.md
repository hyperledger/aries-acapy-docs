...
The [publishing](https://github.com/hyperledger/aries-cloudagent-python/blob/0.11.3/PUBLISHING.md) document provides information on tagging a release and publishing the release artifacts to PyPi.
