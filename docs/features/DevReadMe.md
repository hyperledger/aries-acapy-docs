...
The [publishing](https://github.com/hyperledger/aries-cloudagent-python/blob/1.0.0-rc2/PUBLISHING.md) document provides information on tagging a release and publishing the release artifacts to PyPi.
